...
SELECT * FROM books LEFT JOIN categories ON books.category_id = category_id;

SELECT * FROM books LEFT JOIN categories ON books.category_id = categories.id WHERE books.id=1;
...
SELECT books.id AS book_id, books.title, books.category_id, books.img, books.author, books.summary, books.price, categories.id AS category_ref_id, categories.category_name AS category_name FROM books LEFT JOIN categories ON books.category_id = categories.id WHERE books.id = ?;
